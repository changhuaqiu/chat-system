    ...
    <div className="w-80 bg-white border-l border-[#e5e5ea] flex flex-col h-full transition-all duration-200">
      ...
      <div className="p-5 border-b border-[#e5e5ea] bg-[#fafafa]">
        <button
          ...
          className="w-full bg-[#af52de] text-white py-2.5 px-4 rounded-xl font-medium hover:bg-[#8b3fb3] transition-all flex items-center justify-center gap-2 shadow-sm hover:translate-y-[-1px] hover:shadow-md"
        >
